...
class NoteStyle implements IRegistryEntry<NoteStyleData>
{
  ...
  public function buildNoteSprite(target:NoteSprite):Void
  {
    ...
    target.antialiasing = (_data.assets?.note?.isPixel ?? false) ? false : Preferences.antialiasing;
  ...
  public function applyStrumlineFrames(target:StrumlineNote):Void
  {
    ...
    target.antialiasing = (_data.assets.noteStrumline?.isPixel ?? false) ? false : Preferences.antialiasing;
  }
  ...
  public function buildCountdownSprite(step:Countdown.CountdownStep):Null<FunkinSprite>
  {
    ...
    result.antialiasing = isCountdownSpritePixel(step) ? false : Preferences.antialiasing;
    result.updateHitbox();
  ...
  public function buildJudgementSprite(rating:String):Null<FunkinSprite>
  {
    ...
    result.antialiasing = isPixel ? false : Preferences.antialiasing;
  ...
  public function buildSplashSprite(target:NoteSplash):Void
  {
    ...
    target.frames = atlas;
    target.antialiasing = (_data.assets.noteSplash?.isPixel ?? false) ? false : Preferences.antialiasing;
  ...
  public function buildHoldCoverSprite(target:NoteHoldCover):Void
  {
    ...
    target.antialiasing = (_data.assets.holdNoteCover?.isPixel ?? false) ? false : Preferences.antialiasing;
    target.glow.antialiasing = (_data.assets.holdNoteCover?.isPixel ?? false) ? false : Preferences.antialiasing;
